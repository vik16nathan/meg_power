Inputs: Primary current dipoles calculated at 15,002 points in the brain following all processing instructions in the Brainstorm tutorials (https://neuroimage.usc.edu/brainstorm/Tutorials/), with a few notable exceptions:
